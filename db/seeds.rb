...
shield1 = Item.create(name: "Buttwiper Helmet", cost: "150", weight: 7, armor: 13)
shield2 = Item.create(name: "Raul's Glasses", cost: "350", weight: 1, armor: 14)
shield3 = Item.create(name: "Blaze It Shield", cost: "420", weight: 20, armor: 13)
shield4 = Item.create(name: "Nike Toe Boots", cost: "450", weight: 10, armor: 14)
shield5 = Item.create(name: "Dino Suit", cost: "500", weight: 9, armor: 12)
shield6 = Item.create(name: "N95 Masks", cost: "800", weight: 1, armor: 12)
